...
@pytest.mark.parametrize(
    "partial_body",
    [{"error_rate": 0.5}, {"latency_multiplier": 2.0}, {}],
)
...
def test_admin_chaos_put_rejects_out_of_range_values(error_rate, latency_multiplier):
    response = client.put(
        "/admin/chaos",
        json={"error_rate": error_rate, "latency_multiplier": latency_multiplier},
    )
